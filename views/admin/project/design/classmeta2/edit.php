...
<div class="contentBox allWidth">
	...
	<div class="spanLine">
	    <div class="spanStage">
            ...
            <div class="spanLineLeft">
                <input type="text" class="text" name="classname" placeholder="標籤名稱" value="<?=$class_ClassMeta->classname?>">
            </div>
		</div>
	    <div class="spanStage">
            <div class="spanLineLeft">
    ...
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft width300">
                ...
                <p><a href="admin/shop/product/product/classmeta/tablelist">管理二級分類</a></p>
            </div>
        </div>
    </div>
    <?endif?>
