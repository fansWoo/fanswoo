...
<div class="contentBox allWidth">
    ...
    <?php echo form_open_multipart("admin/$child1_name/$child2_name/$child3_name/{$child4_name}_ga_post/") ?>
    <div class="spanLine">
        <div class="spanStage">
...
<div class="contentBox allWidth">
    ...
    <?php echo form_open_multipart("admin/$child1_name/$child2_name/$child3_name/{$child4_name}_fb_post/") ?>
    <div class="spanLine">
        <div class="spanStage">
            <div class="spanLineLeft">
            外掛原始碼
...
<div class="contentBox allWidth">
    ...
    <?php echo form_open_multipart("admin/$child1_name/$child2_name/$child3_name/{$child4_name}_custom_post/") ?>
    <div class="spanLine">
        <div class="spanStage">
            <div class="spanLineLeft">
            外掛原始碼
