...
<div class="contentBox allWidth">
    ...
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft width300">
                ...
                <div>
                    <select name="classids_arr[]" required>
    ...
    <div class="spanLine">
        ...
        <div class="spanStage">
            ...
            <div class="spanLineLeft width500">
                <span class="gray">多張圖檔將以第一張為默認顯示圖檔</span>
            </div>
        </div>
    </div>
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineRight">
                ...
                <textarea cols="80" id="content" name="content" rows="10"><?=$NoteField->content_Html?></textarea>
            </div>
        </div>
    </div>
    <div class="spanLine">
