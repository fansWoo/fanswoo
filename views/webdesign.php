			...
			<div class="box2">
				...
				<div class="webdesignTop">
					<p style="margin-bottom:20px;">
						您知道嗎？<span class="red">全世界有78%的網站是賠錢貨</span>！因為設計不良的網站不只無法帶動業績提升，還會造成負面形象！
					</p>
					<p>
						為此我們不斷嘗試跳脫每個使用者所認識的網站，為了讓使用者能在第一眼就對網站留下深刻的印象，我們對每一個企業做完整的分析，<span class="blue">為企業做出品牌的差異化</span>，讓網站不只是單純的傳播資訊，還能夠達到提升企業形象、強化產品價值、增加公司業績的效果。
					</p>
				</div>
				<div class="webdesignNotice">
					<h3>網頁設計一定要問清楚的事項！</h3>
					<p>1.許多公司以數萬元出售成本不到一千元的套版軟體</p>
					<p>2.許多公司不提供PHP原始碼，導致其它設計師無法修改</p>
					<p>3.許多公司鎖住FTP、MySQL導致網站無法搬移</p>
				</div>
			</div>
		</div>
