			...
			<div class="area">
				...
				<div class="box2">
					...
					<div class="webdesignTop">
						<p>
							從前，網路僅是傳播資訊的管道之一，而現在網路成了消費者認識企業品牌最直接的管道，甚至可以說，網站的質感決定了企業品牌的形象。為此我們不斷嘗試跳脫每個使用者所認識的網站，為了讓使用者能在第一眼就對網站留下深刻的印象，我們對每一個企業做完整的分析，為企業做出品牌的差異化，讓網站不只是單純的傳播資訊，還能夠達到提升企業形象、強化產品價值、增加公司業績的效果。
						</p>
					</div>
