...
$admin['ac_father_online'] = array(
	...
	'websiteset', 'webcontent', 'note', 'showroom', 'brand', 'album'
);
		...
		'ac_father' => array(
			...
			array(
				...
				'ac_child' => array(
					...
					array('title' => '新增相簿', 'name' => 'postclass'),
					array('title' => '照片列表', 'name' => 'piclist'),
					array('title' => '相簿列表', 'name' => 'classlist'),
			...
			array(
				...
				'ac_child' => array(
					...
					array('title' => '新增藝廊分類', 'name' => 'postclass'),
					array('title' => '展示藝廊列表列表', 'name' => 'showroomlist'),
					array('title' => '藝廊分類列表', 'name' => 'classlist'),
					array('title' => '展示藝廊設置', 'name' => 'set')
				)
			),
			array(
