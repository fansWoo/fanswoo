		...
		<div class="newsContent">
			...
			<?else:?>
				...
				<div class="commentList">
					...
					<div class="fb-comments pc" data-href="http://web.fanswoo.com/business/note/view/<?=$note['noteid']?>" data-width="520"></div>
					<div class="fb-comments phone" data-href="http://web.fanswoo.com/business/note/view/<?=$note['noteid']?>" data-width="300"></div>
				</div>
			<?endif?>
		</div>
<?=$temp['footer']?>