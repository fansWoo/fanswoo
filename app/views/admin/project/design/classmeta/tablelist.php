    ...
    <div class="spanLineTable">
        <div class="spanLineTableContent">
            ...
            <div class="spanLine tablelist">
                ...
                <div class="spanLineLeft width200 tablelistMenu">
                    <a href="admin/<?=$child1_name_Str?>/<?=$child2_name_Str?>/design/tablelist/?class_slug=<?=$value_ClassMeta->slug_Str?>">查看設計項目</a>
