...
<div class="contentBox allWidth">
    ...
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft">
                <input type="text" class="text" name="classname_Str" placeholder="專案類別名稱" value="<?=$class_ClassMeta->classname_Str?>">
            </div>
        </div>
        <div class="spanStage">
            <div class="spanLineLeft">
            ...
            <div class="spanLineRight">
                <p class="gray">請輸入專案類別標籤的名稱，此標籤名稱將作為專案類別名稱</p>
            </div>
        </div>
    </div>
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft">
                <input type="text" class="text" name="slug_Str" placeholder="專案類別代號" value="<?=$class_ClassMeta->slug_Str?>">
            </div>
        </div>
        <div class="spanStage">
            <div class="spanLineLeft">
            ...
            <div class="spanLineRight">
                <p class="gray">請填寫專案類別標籤的代號，此標籤代號將作為搜尋關鍵字</p>
                <p class="gray">本值需為英文及數字組合，不得含有中文，並且不得與其它專案類別標籤有重複</p>
            </div>
        </div>
    </div>
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft width400">
                <textarea name="content_Str" placeholder="專案類別簡介"><?=$class_ClassMeta->content_Str?></textarea>
            </div>
        </div>
        <div class="spanStage">
            <div class="spanLineLeft">
            ...
            <div class="spanLineRight">
                <p class="gray">請填寫200字以內的專案類別簡介</p>
            </div>
        </div>
    </div>
    <div class="spanLine">
