...
$pdf->SetTitle('fansWoo Example');
$pdf->SetSubject('fansWoo Tutorial');
$pdf->SetKeywords('fansWoo, PDF, example, test, guide');
// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'fansWoo Example', PDF_HEADER_STRING);
