...
class SimpleHtmlDom {
    ...
    function load_file() {
        ...
        // Per the SimpleHtmlDom repositiry this is a planned upgrade to the codebase.
    ...
    protected function read_tag() {
        ...
        if ($this->char==='/') {
            $this->char = (++$this->pos<$this->size) ? $this->doc[$this->pos] : null; // next
            // This represetns the change in the SimpleHtmlDom trunk from revision 180 to 181.
